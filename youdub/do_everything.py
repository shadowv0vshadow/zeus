    ...
    for retry in range(max_retries):
        try:
            ...
            translate_all_transcript_under_folder(
                folder, target_language=translation_target_language, model_provider=translation_model_provider
            )

            # 4. 语音合成
            generate_all_wavs_under_folder(
                folder, tts_model=tts_model, xtts_model_name=xtts_model_name, aliyun_voice=aliyun_voice
            )
